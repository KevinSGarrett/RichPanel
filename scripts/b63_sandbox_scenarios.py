...
_DEFAULT_FOLLOWUP_MESSAGE = (
    "Following up on my order status. Any tracking update?"
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--followup-message",
        default=_DEFAULT_FOLLOWUP_MESSAGE,
        help="Custom follow-up message for golden path follow-up payloads.",
    )
    parser.add_argument(
        "--artifacts-dir",
