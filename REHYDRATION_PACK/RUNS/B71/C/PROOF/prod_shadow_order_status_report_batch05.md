...
- Run ID: `RUN_20260205_1701Z`
- Generated (UTC): 2026-02-05T17:05:27.738373+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 9 tickets; 6 matched by order number and 3 matched by email.
- Global order-status rate: 36.0%
- Match rate among order-status: 100.0%
- Tracking present for 9 order-status tickets; ETA available for 0 when no tracking.
