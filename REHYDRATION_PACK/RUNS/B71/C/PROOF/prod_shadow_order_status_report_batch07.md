...
- Run ID: `RUN_20260205_1711Z`
- Generated (UTC): 2026-02-05T17:15:58.435048+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 10 tickets; 7 matched by order number and 3 matched by email.
- Global order-status rate: 40.0%
- Match rate among order-status: 100.0%
- Tracking present for 9 order-status tickets; ETA available for 1 when no tracking.
