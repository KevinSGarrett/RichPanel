...
- Run ID: `RUN_20260205_1641Z`
- Generated (UTC): 2026-02-05T16:46:17.087701+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 13 tickets; 9 matched by order number and 4 matched by email.
- Global order-status rate: 52.0%
- Match rate among order-status: 100.0%
- Tracking present for 12 order-status tickets; ETA available for 1 when no tracking.
...
| Classified order status (false) | 12 |
| Order-status rate | 52.0% |
