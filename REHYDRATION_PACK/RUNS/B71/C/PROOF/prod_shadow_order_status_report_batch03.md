...
- Run ID: `RUN_20260205_1647Z`
- Generated (UTC): 2026-02-05T16:51:07.951015+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 8 tickets; 5 matched by order number and 3 matched by email.
- Global order-status rate: 32.0%
- Match rate among order-status: 100.0%
- Tracking present for 8 order-status tickets; ETA available for 0 when no tracking.
...
| --- | --- |
| Tickets scanned | 25 |
| Classified order status (true) | 8 |
| Classified order status (false) | 17 |
...
| Metric | Count |
| --- | --- |
| Order-status count | 8 |
| Match attempted | 8 |
| Matched by order number | 5 |
| Matched by email | 3 |
| Match rate among order-status | 100.0% |
| Tracking present | 8 |
| Tracking rate | 100.0% |
