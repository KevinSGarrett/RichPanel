...
- Run ID: `RUN_20260205_1722Z`
- Generated (UTC): 2026-02-05T17:23:04.266465+00:00
- Environment: `prod`
- Classification source: `openai_intent`
- Classification source counts: openai_intent: 1
- Tickets scanned: 1
...
- OpenAI routing calls: 1; OpenAI intent calls: 1.
- Errors: 0
...
| Classified order status (false) | 1 |
| Order-status rate | 0.0% |
| OpenAI routing called | 1 |
| OpenAI intent called | 1 |
