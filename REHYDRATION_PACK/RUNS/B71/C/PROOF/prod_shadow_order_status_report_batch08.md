...
- Run ID: `RUN_20260205_1716Z`
- Generated (UTC): 2026-02-05T17:20:26.026019+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 11 tickets; 7 matched by order number and 4 matched by email.
- Global order-status rate: 44.0%
- Match rate among order-status: 100.0%
- Tracking present for 11 order-status tickets; ETA available for 0 when no tracking.
...
| --- | --- |
| Tickets scanned | 25 |
| Classified order status (true) | 11 |
| Classified order status (false) | 14 |
| Order-status rate | 44.0% |
