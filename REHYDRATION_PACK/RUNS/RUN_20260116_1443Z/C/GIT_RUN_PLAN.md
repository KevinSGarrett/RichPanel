...
- [ ] Pull latest `main` (not required for this run; working off existing branch)
- [ ] Merge agent branches (not applicable; sequential)
- [x] Run: `python scripts/run_ci_checks.py --ci`
- [ ] Merge PR (pending)
- [ ] Confirm Actions are green (Codecov + Bugbot) on latest head
