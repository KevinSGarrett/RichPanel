...
Archived as part of `RUN_20260112_1444Z`.
...
- **Model used:** gpt-5.1-codex-max-xhigh (see REHYDRATION_PACK/07_CURSOR_MODEL_CATALOG.md)
- **MAX mode:** ON | OFF
- **Cycle:** 1× | 2× | 3× | 4×
```
...
4) When the cycle ends, archive the prior prompt text under `REHYDRATION_PACK/RUNS/RUN_20260112_1444Z/C/`
