...
|---|---|---|---|
| run_ci_checks (CI mode) | `python scripts/run_ci_checks.py --ci` | fail (dirty tree) | `REHYDRATION_PACK/RUNS/RUN_20260219_0628Z/A/evidence/run_ci_checks_ci.log` |
...
## Notes
`run_ci_checks.py --ci` will be rerun after the worktree is clean (blocked by
untracked prior-run evidence files).
