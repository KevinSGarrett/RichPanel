...
- CI status at end of run: green (validate pass, codecov/patch pass, Bugbot no findings; claude-review skipped)
- Main updated: no
- Branch cleanup done: no

## Tests and evidence
- Tests run: `python scripts/run_ci_checks.py --ci` (local pass with run artifacts stashed)
- Evidence path/link: https://github.com/KevinSGarrett/RichPanel/actions/runs/21054059591/job/60546419572
