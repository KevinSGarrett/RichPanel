# Archive — prior `REHYDRATION_PACK/06_AGENT_ASSIGNMENTS.md` prompt content

Archived as part of B06 pack snapshot refresh (2026-01-03) to prevent “stale prompts” confusion.
