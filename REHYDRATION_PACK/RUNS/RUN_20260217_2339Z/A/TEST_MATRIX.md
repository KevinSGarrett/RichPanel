...
|---|---|---|---|
| CI checks | `python scripts/run_ci_checks.py --ci` | fail | `REHYDRATION_PACK/RUNS/RUN_20260217_2339Z/A/RUN_REPORT.md` |
...
## Notes
CI checks failed due to pre-existing uncommitted run artifacts plus regenerated docs; pytest passed when AWS region env vars were set.
