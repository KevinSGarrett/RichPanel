...
- Run ID: `RUN_20260204_0106Z`
- Generated (UTC): 2026-02-04T01:07:27.310185+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 6 tickets; 0 matched by order number and 0 matched by email.
...
| --- | --- |
| Tickets scanned | 25 |
| Classified order status (true) | 6 |
| Classified order status (false) | 19 |
