...
- Run ID: `RUN_20260204_0214Z`
- Generated (UTC): 2026-02-04T02:17:52.080710+00:00
- Environment: `prod`
- Classification source: `mixed`
- Classification source counts: openai_intent: 24, deterministic_router: 1
- Tickets scanned: 25
...
## Executive Summary
- Order-status subset: 15 tickets; 0 matched by order number and 0 matched by email.
- Global order-status rate: 60.0%
...
| Classified order status (false) | 10 |
| Order-status rate | 60.0% |
