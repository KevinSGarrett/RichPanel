...
- Run ID: `RUN_20260207_0131Z`
- Generated (UTC): 2026-02-07T01:38:29.808556+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 23 tickets; 17 matched by order number and 5 matched by email.
...
- Tracking present rate (matched only): 86.4%; ETA available rate (matched only): 9.1%.
...
| Tracking present | 19 |
| Tracking rate | 82.6% |
| Tracking present rate (matched only) | 86.4% |
