...
- Run ID: `RUN_20260207_0046Z`
- Generated (UTC): 2026-02-07T00:53:53.528452+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 20 tickets; 15 matched by order number and 4 matched by email.
- Global order-status rate: 40.0%
- Match rate among order-status: 95.0%
- Tracking present for 18 order-status tickets; ETA available for 1 when no tracking.
- Tracking present rate (matched only): 94.7%; ETA available rate (matched only): 5.3%.
...
| --- | --- |
| Tickets scanned | 50 |
| Classified order status (true) | 20 |
| Classified order status (false) | 30 |
...
| Metric | Count |
| --- | --- |
| Order-status count | 20 |
| Order-status match success | 19 |
...
| Tracking present | 18 |
| Tracking rate | 90.0% |
| Tracking present rate (matched only) | 94.7% |
| ETA available when no tracking | 1 |
| ETA rate when no tracking | 50.0% |
| ETA available rate (matched only) | 5.3% |
