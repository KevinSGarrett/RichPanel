...
- Run ID: `RUN_20260207_0153Z`
- Generated (UTC): 2026-02-07T02:00:43.195948+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 12 tickets; 7 matched by order number and 0 matched by email.
- Global order-status rate: 24.0%
- Match rate among order-status: 58.3%
- Tracking present for 7 order-status tickets; ETA available for 0 when no tracking.
...
| --- | --- |
| Tickets scanned | 50 |
| Classified order status (true) | 12 |
| Classified order status (false) | 38 |
| Order-status rate | 24.0% |
...
| Metric | Count |
| --- | --- |
| Order-status count | 12 |
| Order-status match success | 7 |
| Order-status no match | 5 |
| Match attempted | 12 |
