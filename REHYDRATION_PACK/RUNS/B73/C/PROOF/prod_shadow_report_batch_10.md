...
- Run ID: `RUN_20260207_0146Z`
- Generated (UTC): 2026-02-07T01:53:13.756688+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 13 tickets; 9 matched by order number and 0 matched by email.
- Global order-status rate: 26.0%
- Match rate among order-status: 69.2%
- Tracking present for 8 order-status tickets; ETA available for 1 when no tracking.
- Tracking present rate (matched only): 88.9%; ETA available rate (matched only): 11.1%.
...
| Classified order status (false) | 37 |
| Order-status rate | 26.0% |
...
| ETA rate when no tracking | 20.0% |
| ETA available rate (matched only) | 11.1% |

## Top Failure Modes (Order-status subset)
- missing_order_number: 2
- missing_order_number_and_email: 2

## Top No-Match Reasons (Order-status subset)
- shopify_lookup_0_results: 2
- no_customer_email_on_ticket: 2
