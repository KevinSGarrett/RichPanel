...
- Run ID: `RUN_20260207_0054Z`
- Generated (UTC): 2026-02-07T01:01:08.462604+00:00
- Environment: `prod`
...
- Tracking present rate (matched only): 90.5%; ETA available rate (matched only): 9.5%.
...
| Tracking present | 19 |
| Tracking rate | 90.5% |
| Tracking present rate (matched only) | 90.5% |
| ETA available when no tracking | 2 |
| ETA rate when no tracking | 100.0% |
| ETA available rate (matched only) | 9.5% |
