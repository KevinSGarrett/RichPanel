...
- Run ID: `RUN_20260206_1558Z`
- Generated (UTC): 2026-02-06T16:06:33.312336+00:00
- Environment: `prod`
...
## Executive Summary
- Order-status subset: 19 tickets; 13 matched by order number and 6 matched by email.
- Global order-status rate: 38.0%
- Match rate among order-status: 100.0%
- Tracking present for 17 order-status tickets; ETA available for 0 when no tracking.
...
| --- | --- |
| Tickets scanned | 50 |
| Classified order status (true) | 19 |
| Classified order status (false) | 31 |
| Order-status rate | 38.0% |
