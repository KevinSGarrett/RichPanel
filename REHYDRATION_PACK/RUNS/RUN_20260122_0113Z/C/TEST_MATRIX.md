...
| CI-equivalent checks | python scripts/run_ci_checks.py --ci | fail (dirty tree) | c:\Users\kevin\.cursor\projects\c-Users-kevin-AppData-Roaming-Cursor-Workspaces-1768173996229-workspace-json\agent-tools\b7bbe862-70b8-4f67-9dd2-8b9ffc512929.txt |

## Notes
CI checks failed only because regenerated outputs and run artifacts were not committed yet.
