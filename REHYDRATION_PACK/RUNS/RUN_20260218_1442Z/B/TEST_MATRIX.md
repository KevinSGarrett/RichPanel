...
|---|---|---|---|
| CI-equivalent | RICHPANEL_OUTBOUND_ENABLED=0 RICHPANEL_READ_ONLY=1 AWS_REGION=us-east-2 AWS_DEFAULT_REGION=us-east-2 CLAUDE_GATE_AUDIT_PATH=C:\\Temp\\claude_gate_audit.json python scripts/run_ci_checks.py --ci | pass | REHYDRATION_PACK/RUNS/RUN_20260218_1442Z/B/RUN_REPORT.md |
...
- Set `CLAUDE_GATE_AUDIT_PATH` outside the repo to avoid untracked audit artifacts.
