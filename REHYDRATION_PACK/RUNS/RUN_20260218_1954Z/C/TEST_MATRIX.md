...
| Read-only shadow eval (ticket IDs) | `python scripts/live_readonly_shadow_eval.py --ticket-id ...` | partial (ticket ok; conversation 403; Shopify auth fail) | `REHYDRATION_PACK/RUNS/RUN_20260218_1954Z/C/evidence/prod_shadow_summary.json` |
