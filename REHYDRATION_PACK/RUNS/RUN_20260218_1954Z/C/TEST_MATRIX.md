...
| Prod kill-switch check | `aws ssm get-parameters --names <safe_mode> <automation_enabled>` | fail (safe_mode=false, automation_enabled=true) | `REHYDRATION_PACK/RUNS/RUN_20260218_1954Z/C/evidence/prod_safe_mode_automation_status.txt` |
