...
| Deploy Prod Stack | GitHub Actions workflow run 22161726807 | pass | `REHYDRATION_PACK/RUNS/RUN_20260218_1954Z/C/evidence/deploy_prod_log.txt` |
...
| Read-only shadow eval (ticket IDs) | `python scripts/live_readonly_shadow_eval.py --ticket-id ... --skip-conversations` | pass (rewrite_model_used + greeting/key details/Holly fields) | `REHYDRATION_PACK/RUNS/RUN_20260218_1954Z/C/evidence/prod_shadow_summary.json` |
| Rewrite proof note | N/A | pass (direct proof fields in report) | `REHYDRATION_PACK/RUNS/RUN_20260218_1954Z/C/evidence/prod_shadow_rewrite_inference.md` |
