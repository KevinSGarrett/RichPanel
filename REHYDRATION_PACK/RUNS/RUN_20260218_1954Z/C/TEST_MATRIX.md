...
| Read-only shadow eval (ticket IDs) | `python scripts/live_readonly_shadow_eval.py --ticket-id ... --skip-conversations` | partial (ticket ok; order_status candidate; OpenAI calls observed) | `REHYDRATION_PACK/RUNS/RUN_20260218_1954Z/C/evidence/prod_shadow_summary.json` |
