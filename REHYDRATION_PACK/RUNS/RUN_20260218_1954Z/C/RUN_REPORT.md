...
```
 ...
 .../RUNS/RUN_20260218_1954Z/C/RUN_REPORT.md        |  81 +++++++++++++++++
 ...
 31 files changed, 887 insertions(+), 3 deletions(-)
```
...
- `python scripts/run_ci_checks.py --ci` - CI-equivalent checks (failed due to uncommitted generated outputs).
...
- `python scripts/run_ci_checks.py --ci` - fail (generated files changed after regen) - evidence: `REHYDRATION_PACK/RUNS/RUN_20260218_1954Z/C/evidence/`
...
- [ ] Rerun CI checks after committing generated outputs and update evidence.
