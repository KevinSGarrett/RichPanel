...
- Retried shadow eval via workflow and per-ticket local runs; workflow blocked by disabled OpenAI routing, local runs fetched tickets with Shopify ok but conversation 403; order_status candidate + OpenAI calls observed (rewrite inference noted).
