...
- Retried shadow eval via workflow and per-ticket local runs; workflow blocked by disabled OpenAI routing, local runs used /v1/tickets only with Shopify ok; report now includes explicit rewrite_model_used + greeting/key details/Holly proof fields.
