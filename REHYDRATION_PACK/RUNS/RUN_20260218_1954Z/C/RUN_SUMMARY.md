...
- Retried shadow eval via workflow and per-ticket local runs; workflow blocked by disabled OpenAI routing, local runs fetched tickets but hit conversation 403 + Shopify auth failures (no rewrite proof yet).
