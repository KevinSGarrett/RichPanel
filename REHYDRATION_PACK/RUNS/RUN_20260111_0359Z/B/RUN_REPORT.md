...
## What shipped (TL;DR)
- CI workflow now runs unit tests under coverage and treats ruff/black/mypy as blocking.
...
## Follow-ups
- Push updated branch, monitor CI + Codecov upload, enable auto-merge, and drop the run link into `B/`.
