...
## Notes
run_ci_checks executed from a clean tree; evidence log copied into run artifacts after pass. CDK diff includes Lambda asset S3Key changes beyond env vars.
