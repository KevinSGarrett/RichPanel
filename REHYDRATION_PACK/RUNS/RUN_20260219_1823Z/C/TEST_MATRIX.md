...
|---|---|---|---|
| CI checks | `python scripts/run_ci_checks.py --ci` | fail (regen outputs pending commit) | `REHYDRATION_PACK/RUNS/RUN_20260219_1823Z/C/evidence/run_ci_checks_ci.log` |
...
## Notes
run_ci_checks must be rerun after staging/committing regenerated docs.
