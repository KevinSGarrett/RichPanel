...
|---|---|---|---|---|
| order_status_tracking | Email Support Team | mw-intent-order-status | Tier 1 + Tier 2 | Tier 2 only with deterministic match |
| shipping_delay_not_shipped | Email Support Team | mw-intent-shipping-delay | Tier 1 + Tier 2 | No promised dates |
