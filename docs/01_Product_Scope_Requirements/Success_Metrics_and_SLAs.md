...
Last verified: 2025-12-29 — Updated for Wave F13 (CR-001 auto-close whitelist + no-tracking ETA)ne latency targets and controlled auto-close policy (whitelisted only; CR-001 adds order-status ETA auto-close).
...
- Middleware must **auto-close only for whitelisted, deflection-safe templates** tickets.
