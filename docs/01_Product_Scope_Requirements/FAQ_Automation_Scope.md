...
Last verified: 2025-12-21 — Updated with confirmed policies (shipping exceptions, chargebacks, DNR).
...
You confirmed:
- **Never auto-close** tickets from the middleware.

The middleware may:
- add tags
- add internal notes (decision trace)
- send allowed replies (Tier 1/Tier 2)
But it should not close or mark “resolved” automatically.
