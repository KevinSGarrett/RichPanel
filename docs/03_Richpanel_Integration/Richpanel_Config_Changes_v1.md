...
Last verified: 2025-12-22 — Updated with safer middleware-trigger placement (Tagging Rules first) and payload robustness notes.
...
| Automations | Disable/replace current **chargeback auto-close** rules | Conflicts with “never auto-close” + chargeback queue requirement | Support Ops |
...
- **Policy:** Tier 0 — *never auto-reply; never auto-close*; human-only
