...
Last verified: 2025-12-21 — Created initial integration test matrix for HTTP Target + routing tags + safe auto-replies.
...
- chargeback cases never auto-close and never auto-reply
