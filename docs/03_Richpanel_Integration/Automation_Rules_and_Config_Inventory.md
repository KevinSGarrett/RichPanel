...
Last verified: 2025-12-29 — Expanded inventory with “skip subsequent rules” + “reassign” flags and documented routing-fight risks.
...
| **Chargeback auto-close rules** | Subject contains chargeback patterns | N/A | **Closes** conversation automatically | Conflicts with policy (“auto-close only for whitelisted, deflection-safe templates (and never for Tier 0)”) |
...
- ✅ Middleware must **auto-close only for whitelisted, deflection-safe templates (and never for Tier 0)** tickets.
