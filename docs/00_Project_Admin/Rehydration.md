...
Last verified: 2025-12-22 — Wave 06 closed (security baseline + monitoring/rotation/break-glass). Richpanel tenant verification remains deferred.
...
- Wave 04: ✅ closed
- Wave 05: ✅ closed (FAQ automation templates + playbooks + macro governance complete)
  - v1 auto-send channels: **LiveChat + Email**
  - v1 route-only channels: **Social/TikTok/Phone**
  - sender identity: **Support** (not “Bot”)
  - “Automated update:” label: disabled by default
  - policy/help links: disabled by default (URLs blank until set)
  - pre-launch checklist: `docs/05_FAQ_Automation/Pre_Launch_Copy_and_Link_Checklist.md`
- Wave 06: 🟡 in progress (security/privacy/compliance hardening)
  - Wave 06 docs live in `docs/06_Security_Privacy_Compliance/`.
  - Added in Update 2: AWS security baseline checklist + kill switch/safe mode plan.
- Deferred: Richpanel tenant verification (webhook trigger/UI capabilities) — tracked in `Progress_Wave_Schedule.md`
...
- Can automation conditions express “Tags does not contain …”?
